        ...
        <footer className="bg-white dark:bg-gray-900">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <div className="flex items-center">
                            <img src={botpressImg} className="h-8 me-3 mix-blend-multiply" alt="Botpress Logo" />
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://botpress.com/pt" className="hover:underline">Botpress™</a>. Todos os direitos reservados.
                    </span>
